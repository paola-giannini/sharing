...
(* Vector of length n, having at ith position the class of the
   ...
   classMapVector e is thus the tabulation of the map sending an
...
Notation "e '↓' t" := (Vector.nth (erMapVector e) t)
                        (at level 5). (* \downarrow *)
...
Notation  "e1 '•' e2" :=  (* \bullet *)
          (@composeER _ _ _ e1 e2) (at level 60, right associativity).
...
Lemma idRelLeftNeutral : ∀ {n c : nat}, ∀ e : ER n c,
           △ • e = e.
Proof.
...
Lemma idRelRightNeutral : ∀ {n c : nat}, ∀ e : ER n c,
           e • △ = e.
Proof.
  intro n.
  induction n; destruct c; intro e.
